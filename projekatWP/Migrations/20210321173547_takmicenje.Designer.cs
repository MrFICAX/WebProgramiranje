...
namespace projekatWP_bar.Migrations
{
    ...
    [Migration("20210321173547_takmicenje")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projekatWP.Model.Klub", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("projekatWP.Model.Takmicar", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("projekatWP.Model.Takmicenje", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("projekatWP.Model.Klub", b =>
                {
                    b.HasOne("projekatWP.Model.Takmicenje", "Takmicenje")
                        .WithMany("Klubovi")
            ...
            modelBuilder.Entity("projekatWP.Model.Takmicar", b =>
                {
                    b.HasOne("projekatWP.Model.Klub", "Klub")
                        .WithMany("Takmicari")
